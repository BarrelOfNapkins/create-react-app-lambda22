...
import { Splide, SplideSlide, SplitSlide } from "@splidejs/react-splide";
...
function Veggie() {
  ...
  const getVeggie = async () => {
    ...
    if(check){
      ...
      const api = await fetch(`https://api.spoonacular.com/recipes/random?apiKey=${process.env.REACT_APP_SPOONACULAR_KEY}&number=9&tags=vegetarian`) //notice the backtacks (not quotes)
